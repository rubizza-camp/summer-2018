...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name('Fido')
    assert_equal __(['@name'], %i[@name]), fido.instance_variables
  end
  ...
  # rubocop : disable AmbiguousBlockAssociation, EvalWithLocation
  ...
  # rubocop : enable AmbiguousBlockAssociation, EvalWithLocation
