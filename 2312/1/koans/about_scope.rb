...
# The AboutScope class is responsible for smth
class AboutScope < Neo::Koan
  # The Jims module is responsible for smth too
  module Jims
    # The Dog mudule is responsible for fucks sake
    class Dog
      def identify
        :jims_dog
      end
  ...
  # resposible for strenght
  module Joes
    # responsible for GODS SAKE
    class Dog
      def identify
        :joes_dog
      end
  ...
  def testdog_is_not_available_in_the_current_scope
  ...
  def test_you_can_reference_nested_classes_using_the_scope_operator_continue
    fido = Jims::Dog.new
    rover = Joes::Dog.new
