...
# The AboutClasses class is responsible for ...
  class Dog
  end
  ...
  # ------------------------------------------------------------------
  # The Dog2 class is responsible for ...  
  class Dog2
    def set_name(a_name)
      @name = a_name
    end
 ...
 # :reek:DuplicateMethodCall
  ...
  # ------------------------------------------------------------------
  # The Doc3 class is responsible for ...
  class Dog3
    def set_name(a_name)
      @name = a_name
    end
  ...
  # ------------------------------------------------------------------
  # The Dog4 class is responsible for ...
  class Dog4
    attr_reader :name
  ...
  # ------------------------------------------------------------------
  # The Dog6 class is responsible for ...
  class Dog6
    attr_reader :name
  ...
  # ------------------------------------------------------------------
  # The Dog7 class is responsible for ...
  class Dog7
    attr_reader :name
  ...
  def test_to_s_provides_a_string_version_of_the_oject
    fido = Dog7.new("Fido")
