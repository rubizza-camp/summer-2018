...
class AboutStrings < Neo::Koan
  ...
  def test_use_backslash_for_those_hard_cases
    za = "He said, \"Don't\""
    ba= 'He said, "Don\'t"'
    assert_equal true, za == ba
  end

  def test_use_flexible_quoting_to_handle_really_hard_cases
    za = %(flexible quotes can handle both ' and " characters)
    ba = %!flexible quotes can handle both ' and " characters!
    ca = %{flexible quotes can handle both ' and " characters}
    assert_equal true, za == ba
    assert_equal true, za == ca
  end
...
EOS
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, za           == bz
    assert_equal false, za.object_id == bz.object_id
  end
end
