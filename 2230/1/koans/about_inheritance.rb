...
class AboutInheritance < Neo::Koan
  # This class contains info about Dog
  class Dog
    attr_reader :name
  ...
  # This class contains info about Chihuahua
  class Chihuahua < Dog
    def wag
      :happy
    end
  ...
  # This class contains info about BullDog
  class BullDog < Dog
    def bark
      super + ', GROWL'
    end
  ...
  # This class contains info about GreatDane
  class GreatDane < Dog
    def growl
      super.bark + ', GROWL'
    end
