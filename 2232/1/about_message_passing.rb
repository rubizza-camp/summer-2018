...
class AboutMessagePassing < Neo::Koan
  ...
  def test_all_messages_are_caught
    ...
    assert_equal 'Called foobar <>', catcher.foobar
    assert_equal 'Called foobaz <1>', catcher.foobaz(1)
    assert_equal 'Called sum <1, 2, 3, 4, 5, 6>', catcher.sum(1, 2, 3, 4, 5, 6)
  end
