...
# rubocop:disable Lint/ParenthesesAsGroupedExpression, Style/WordArray
...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments_with_wrong_number_of_arguments
    ...
    assert_match(/wrong num/, exception.message)
  end
...
# rubocop:enable Lint/ParenthesesAsGroupedExpression, Style/WordArray
