...
class AboutToStr < Neo::Koan # class AboutToStr
  class CanNotBeTreatedAsString # class CanNotBeTreatedAsString
    def to_s
      'non-string-like'
    end
  end
  ...
  class CanBeTreatedAsString  # class CanBeTreatedAsString
    def to_s
      'string-like'
    end
