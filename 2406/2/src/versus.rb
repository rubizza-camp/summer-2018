...
def get_help
  puts <<-END_HELP
           Use --top-bad-words for Top artist with obscene language
           Use --name for TOP-30 favourite words for this artist
           Use --top-words and --name for TOP favourite words for this artist with checked range
           Use --plagiat for get list of words and artist, who stoled them
           Use --help for that help :-)
           END_HELP
